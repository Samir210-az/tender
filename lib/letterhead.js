...
export function buildFormaOneDeclaration({ tender }) {
  ...
  return [
    ...
    '(g) hər təchizatçı bir təklif: Biz fərdi təchizatçı kimi hər hansı digər təklif və ya təkliflər təqdim etmirik, birgə fəaliyyət üzvü və ya subpodratçı kimi hər hansı digər satınalma və ya satınalmalarda iştirak etmirik və Təlimatın 13-cü hissəsinə uyğun təqdim edilmiş alternativ təkliflər istisna olmaqla Təlimatın 3.3-cü bəndinin tələblərinə cavab veririk;',
