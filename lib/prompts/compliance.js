...
2. Əgər tələbi təsdiqləyən konkret məlumat (evidence) yoxdursa, status "missing" olmalıdır və "evidence" sahəsində "Evidence not found in Company Knowledge Base" yaz.
  ...
  "results": [
    {
      ...
      "evidence": "konkret dəlil (şirkət datasından) və ya 'Evidence not found in Company Knowledge Base'",
