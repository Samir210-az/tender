...
export async function generatePriceSchedulePdf({ tenderName, addresseeLines, signatureLines, rows, grandTotal, currency }) {
  ...
  return new Promise((resolve, reject) => {
    ...
    doc.moveDown(0.8);
    doc.fontSize(18).fillColor('#000000').text('FORMA 2 — QİYMƏT CƏDVƏLİ');
    ...
    const startX = doc.x;
    let y = doc.y;
    const colWidths = [30, 300, 60, 60, 100, 110];
    const headers = ['№', 'Təsvir', 'Ölçü', 'Miqdar', 'Vahid qiyməti', 'Cəm'];
