...
const WORKS_FORMS = [
  ...
  { id: 'forma3', number: 3, name: 'Texniki baza', capability: 'auto' },
  { id: 'forma4', number: 4, name: 'Əsas heyətin tərcümeyi-halı və bəyannaməsi', capability: 'auto' },
  { id: 'forma5', number: 5, name: 'Təchizatçı haqqında', capability: 'auto' },
  { id: 'forma6', number: 6, name: 'Birgə fəaliyyət haqqında', capability: 'not_built_yet', conditional: 'joint_venture' },
...
const GOODS_FORMS = [
  ...
  { id: 'forma4', number: 4, name: 'Birgə fəaliyyət haqqında', capability: 'not_built_yet', conditional: 'joint_venture' },
